...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  let result = hotels.sort((hotel1, hotel2) =>
...
function sortHotelRating(hotel1, hotel2, rating) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let result = hotels.sort((hotel1, hotel2) =>
    sortHotelRating(hotel1, hotel2, rating)
  );
  res.json({ hotels: result });
});

// Endpoint 3: Get the Hotels sorted based on their Reviews
function sortHotelReview(hotel1, hotel2, reviews) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let result = hotels.sort((hotel1, hotel2) =>
    sortHotelReview(hotel1, hotel2, reviews)
  );
  res.json({ hotels: result });
});
